			...
			[
				...
				_List_fromArray(
					[
						...
						A4(mdgriffith$elm_ui$Element$rgba255, 223, 107, 160, 100)),
						mdgriffith$elm_ui$Element$Font$color(
						A4(mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 100))
					]),
				A2(
					...
					_List_fromArray(
						[
							...
							_List_Nil,
							mdgriffith$elm_ui$Element$text('おなまえシールめ〜か〜'))
						])))
			]),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"InputName":["String.String"],"Decrement":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));